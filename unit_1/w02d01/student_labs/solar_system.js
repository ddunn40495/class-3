...
milkyWay.numberOfStars = 400000000000
...
solarSystem[6].moons.pop.push("Oberon")
...
let jupSum = system.Jupiter.satellites
let satSun = system.Saturn.satellites
let uraSum = system.Uranus.satellites
let nepSum = system.Neptune.satellites
