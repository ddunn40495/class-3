...
Create the card game war to play in the console! War is a game where player get dealt cards and the player with the higher number card wins that round! To determine who wins follow these guidelines:

1. Write a function that creates a deck of cards (for now just have it create an array with the numbers 1-14).

1. Write a function to shuffle the deck.

1. Create a player variable where you will store the players card and do the same for the computer as well.

1. Write a function to take the first card off of the deck (array) and deal it to the player and then the computer and then compare the cards to check who wins!

#### WAR BONUS'

1. Add another card to each player if the first draw is a tie.

1. Make a deck with 4 sets of cards to represent suits.
