...
## Attendance
There are no mandatory attendance checks via zoom during the project week, but as always please make sure you're working on your project every day! **Be sure to also be available during the regular class hours in case your instructor needs to reach out to you. Please check Slack daily and make sure to reply to your instructor within the same day if they reach out!**

  - **Wednesday, September 23** Project presentation day! You're required to show up in the classroom zoom at 10AM ET to present your projects.
...
* Add additional relationships (models can be related in a one-to-many relationship, for example)
  - [Optional notes on having two models and relating them](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Moss/tree/master/unit_2/w06d04/instructor_notes)
...
- [Deploying to Heroku](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Moss/blob/master/unit_2/w06d04/morning_exercise/2.%20HEROKU.md)
- [Setting up MongoDB Atlas](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Moss/blob/master/unit_2/w06d04/morning_exercise/1.%20MONGODB_ATLAS.md)
...
❗ Please **DEPLOY EARLY**, and **DEPLOY OFTEN!** Your app working locally does _not_ guarantee that it will work when deployed the same exact way, so whenever you have something working correctly -- please deploy deploy deploy and double check! Do **not** save deployment for the very last day!
...
**Thursday September 17 - Mandatory**<br>
...
Your project is due on Wednesday, September 23 at 10:00 AM ET. You will present your project and show your code to classmates and instructors.

:heavy_check_mark: Add your project to [this google sheet](https://docs.google.com/spreadsheets/d/1T0zmp0kBRseocmZwP2dntlJInG-yNE1_j9tPfF3Jvko/edit?usp=sharing).
...
* **[Mongo Cheatsheet](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Pajama-Pants/wiki/Mongo-Cheatsheet)**
</details>
<hr>  
